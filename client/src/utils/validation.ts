...
export const required: GenericValidator<string, any> = (text) =>
  !text.trim().length;
...
export const isChecked: GenericValidator<boolean, any> = (value) => !value;
export const validateEmail: GenericValidator<string, any> = (email) =>
